...
const ProfileModal = ({ setShowEdit }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-110 h-screen
overflow-y-scroll bg-black/50"
      onClick={() => setShowEdit(false)}
    >
      <div
        className="max-w-2xl sm:py-6 mx-auto"
  ...
  font-medium text-gray-700 mb-1"
              >
                ...
                <input
                  ...
                  accept="image/*"
                  id="profile_picture"
                  className="w-full p-3 border border-gray-200 hidden rounded-lg"
                  onChange={(e) =>
                    setEditForm({
                      ...editForm,
            ...
            <div className="flex flex-col gap-3 items-start">
              ...
              >
                ...
                <div className="group/cover relative">
                  ...
                  />
                  <div className="absolute hidden group-hover:flex inset-0 bg-black/20 rounded-lg items-center justify-center">
                    <Pencil className="w-5 h-5 text-white" />
                  </div>
                </div>
              </label>
