...
import { fetchConnections } from '../features/connections/connectionsSlide';
...
const Connections = () => {
  ...
  const state = useSelector((state) => state.connections);
  console.log(state);
                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    ...
                    {currentTab === 'Connections' && (
                      <button
                        ...
                        className="w-full p-2 text-sm rounded bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition text-white cursor-pointer flex items-center justify-center gap-1"
                      >
