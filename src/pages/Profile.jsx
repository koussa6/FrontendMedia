...
const Profile = () => {
  ...
  return user ? (
    <div className="relative h-full overflow-y-scroll bg-gray-50 p-6 relative">
                    ...
                    {post.image_urls.map((image, index) => (
                      ...
                      >
                        <img
                          ...
                          alt=""
                        />
                        <p className="absolute bottom-0 right-0 text-xs text-white bg-gradient-to-r from-gray-400 to-white/800 hidden group-hover:block px-1 py-1 rounded-l-md">
